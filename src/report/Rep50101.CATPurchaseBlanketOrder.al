report 50101 "CAT Purchase Blanket Order"
{
    // CAT.001 2020-05-12  CL - copied from 10119 Purchase Blanket Order added fields

    DefaultLayout = RDLC;
    //--CAT.001RDLCLayout = './PurchaseBlanketOrder.rdlc';
    RDLCLayout = './src/report/PurchaseBlanketOrder.rdlc'; //++CAT.001
    Caption = 'Purchase Blanket Order 2';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CATBlanketOrderVersionNo; "Purchase Header"."CAT Blanket Order Version No.") { }
                    column(CATPurchaseOrderVersionNoCaption; "Purchase Header".FieldCaption("CAT Purchase Order Version No.")) { }
                    column(CATPurchaseOrderVersionNo; "Purchase Header"."CAT Purchase Order Version No.") { }
                    //<<CAT.001
