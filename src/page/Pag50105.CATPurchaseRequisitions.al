//17.0.0.5 Adding Priority field.
//  - adding rec. to remove implicit with warnings
...
page 50105 "CAT Purchase Requisitions"
{
    ...
    //--CAT.001Caption = 'Purchase Quotes';
    //--CAT.001CardPageID = "Purchase Quote";
    //>>CAT.001
    Caption = 'Purchase Requisitions';
    CardPageID = "CAT Purchase Requisition";
    //<<CAT.001
    ...
    //--CAT.001SourceTableView = WHERE("Document Type" = CONST(Quote));
    SourceTableView = WHERE("Document Type" = CONST(Quote), "CAT Requisition" = CONST(true)); //++CAT.001
    UsageCategory = Lists;
